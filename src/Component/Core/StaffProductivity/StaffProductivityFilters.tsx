...
export interface StaffProductivityFiltersData {
  location: string;
  camera: string;
  cameraCount: number;
}

interface StaffProductivityFiltersProps {
  data?: StaffProductivityFiltersData;
  onDataChange?: (data: StaffProductivityFiltersData) => void;
}
...
function StaffProductivityFilters({ data, onDataChange }: StaffProductivityFiltersProps) {
  const [filtersData, setFiltersData] = useState<StaffProductivityFiltersData>({
    location: 'Main Gate',
...
export default StaffProductivityFilters;
